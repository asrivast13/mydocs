	...
	do 
	  ...
	  if [[ $rc == 0 ]]; 
		then
	  		...
	  		~/projects/kaldi/src/featbin/compute-fbank-feats --config=./fbank.conf "scp:../scp/$id.scp" "ark,scp,t,f:../kaldi/$id.fbank.ark,../kaldi/$id.fbank.scp" >> ../logs/fbank.log 2>&1;
	  ...
	  if [[ $rc == 0 ]];
		then
	  		~/projects/kaldi/src/featbin/paste-feats --length-tolerance=2 ark:../kaldi/$id.pitch.ark ark:../kaldi/$id.fbank.ark ark:../featex/$id.featx.ark "ark,t:../merged/$id.feats.ark" &>> ../logs/paste.log; 
